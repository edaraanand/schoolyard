    ...
    def has_attachment(options = {})
      ...
      unless included_modules.include?(InstanceMethods)
        ...
        if attachment_options[:path_prefix].nil?
          attachment_options[:path_prefix] = File.join("public", table_name)
        end
        ...
        require File.join(File.dirname(__FILE__), "attachmerb_fu/backends/#{backend.snake_case}")
          ...
          when nil
            ...
            begin
              if processors.any?
                ...
                require File.join(File.dirname(__FILE__), "attachmerb_fu/processors/#{attachment_options[:processor].snake_case}")
            ...
            begin
              ...
              require File.join(File.dirname(__FILE__), "attachmerb_fu/processors/#{processor.snake_case}")
